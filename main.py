...
def main():
    ...
    teachers = [
        Teacher("Вчитель 1", ["Математика", "Англійська", "Українська мова", "Історія"]),
        Teacher("Вчитель 2", ["Математика", "Англійська", "Українська мова", "Музика"]),
        Teacher("Вчитель 3", ["Математика", "Англійська", "Українська мова", "Історія"]),
    ...
    lesson_names = [["Математика", False, "None"], ["Англійська", False, "None"], ["Українська мова", False, "None"],
